...
//    int pin,_try=3,totaltry = 0,_proceses,_again = 1,counttry=2;
//    start:
//    	int count = 3;
...
int main(){
    ...
    do{
        ...
        totaltry+= (_try==1) ? _try : (_try+5); //Ternary operator(You cant directly assign value inside of ternary operators
    }while(totaltry<=2);
    if(_try>=2 || _try==0){
